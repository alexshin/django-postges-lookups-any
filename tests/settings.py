...
SECRET_KEY = "8c-nh8t*x)&p6siqu&)yca7^uuh$7bfbzfzl5fs5@=cc#k$43s"
...
INSTALLED_APPS = [
    ...
    'django_postges_lookups_any.test_utils.test_app'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DJANGO_POSTGRES_LOOKUPS_ANY_DB_NAME', 'django_postgres_any_db_name'),
